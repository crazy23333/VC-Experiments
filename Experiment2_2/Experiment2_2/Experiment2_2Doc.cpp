...
// Experiment2_2Doc.cpp : CExperiment2_2Doc 类的实现
//
...
// 缩略图的支持
void CExperiment2_2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CExperiment2_2Doc::InitializeSearchContent()
{
...
void CExperiment2_2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
