...
// Experiment1_1Doc.cpp : CExperiment1_1Doc 类的实现
//
...
// 缩略图的支持
void CExperiment1_1Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CExperiment1_1Doc::InitializeSearchContent()
{
...
void CExperiment1_1Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
