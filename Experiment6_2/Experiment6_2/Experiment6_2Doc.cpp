...
// Experiment6_2Doc.cpp : CExperiment6_2Doc 类的实现
//
...
// 缩略图的支持
void CExperiment6_2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CExperiment6_2Doc::InitializeSearchContent()
{
...
void CExperiment6_2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
