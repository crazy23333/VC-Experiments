...
// Experiment1_3Doc.cpp : CExperiment1_3Doc 类的实现
//
...
// 缩略图的支持
void CExperiment1_3Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CExperiment1_3Doc::InitializeSearchContent()
{
...
void CExperiment1_3Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
