...
// Experiment4_1Doc.cpp : CExperiment4_1Doc 类的实现
//
...
// 缩略图的支持
void CExperiment4_1Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CExperiment4_1Doc::InitializeSearchContent()
{
...
void CExperiment4_1Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
